...
import AlexLouisaMV.repository.*;
...
public class Service {
     ...
     * Class Constructor
     *
     * @param studentFileRepository - ubb.vvss.repository student
     * @param studentValidator      - validator student
     * @param temaFileRepository    - ubb.vvss.repository tema
     * @param temaValidator         - validator tema
     * @param notaFileRepository    - ubb.vvss.repository nota
    ...
    public double addNota(Nota nota, String feedback) {
        ...
        if (predare != tema.getDeadline() && predare - tema.getDeadline() > 0) {
